    ...
    <ElRow :gutter="20" class="mb-5">
      <ElCol :xs="24" :lg="16">
        <div class="art-card chart-card">
          ...
          <ArtLineChart height="340px" :data="trendData" :xAxisData="trendXAxis" :showAreaColor="true" :showAxisLine="false" />
        </div>
      </ElCol>
      ...
      <ElCol :xs="24" :lg="8">
        <div class="art-card chart-card">
          ...
          <ArtRingChart height="340px" :data="toolUsageData" :centerText="t('console.chart.centerText')" :showLegend="true" legendPosition="bottom" />
        </div>
      </ElCol>
    </ElRow>
        ...
        <div class="art-card module-card">
          ...
          <div class="progress-list">
            <div class="progress-item" v-for="item in progressList" :key="item.name">
              ...
              <ElProgress :percentage="item.percent" :stroke-width="8" :show-text="false" :color="item.color" />
    ...
    <ElRow :gutter="20">
      <ElCol :xs="24" :lg="14">
        <div class="art-card module-card">
          ...
          <div class="task-list">
            <div class="task-item" v-for="item in taskListView" :key="item.title" :class="{ done: item.done }">
              <div class="task-main">
