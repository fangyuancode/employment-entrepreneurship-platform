            ...
            <el-col :span="24">
              <el-form-item label="目标用户" prop="targetUsers">
                <el-input
                  ...
                  type="textarea"
                  :rows="3"
                  placeholder="请输入目标用户群体，例如：高校创业团队、独立开发者、文化创作者"
                />
              </el-form-item>
            </el-col>
            ...
            <el-col :span="24">
              <el-form-item label="解决方案" prop="solution">
                <el-input
                  ...
                  type="textarea"
                  :rows="4"
                  placeholder="请输入你的产品方案、AI能力或服务模式"
                />
              </el-form-item>
            </el-col>
            ...
            <el-col :span="24">
              <el-form-item label="商业模式" prop="businessModel">
                <el-input
                  ...
                  type="textarea"
                  :rows="3"
                  placeholder="如：会员订阅、按次付费、企业定制、联名合作等"
                />
              </el-form-item>
            </el-col>
            ...
            <el-col :span="24">
              <el-form-item label="核心竞争优势" prop="competitiveAdvantage">
                <el-input
                  ...
                  type="textarea"
                  :rows="3"
                  placeholder="请输入项目相较于竞品或传统方案的优势"
                />
              </el-form-item>
            </el-col>
