          ...
          <el-row :gutter="16">
            ...
            <el-col :span="24">
              <el-form-item label="参会人提示（可选）">
                <el-select
                  v-model="form.attendeeHints"
                  multiple
                  filterable
                  allow-create
                  default-first-option
                  placeholder="可手动输入参会人"
                  style="width: 100%"
                />
              </el-form-item>
            </el-col>
        ...
        <div class="double-grid">
          <div class="card block-card">
            ...
            <div class="info-list risk-list">
              <div
                v-for="(item, index) in result.riskWarnings"
                :key="index"
                class="info-item risk-item"
              >
                {{ index + 1 }}. {{ item }}
              </div>
            </div>
          ...
          <div class="card block-card">
            ...
            <div class="info-list">
              <div
                v-for="(item, index) in result.followUpSuggestions"
                :key="index"
                class="info-item"
              >
                {{ index + 1 }}. {{ item }}
    ...
    <el-dialog v-model="emailDialogVisible" title="发送会议纪要邮件" width="520px">
      <el-form label-position="top">
        ...
        <el-form-item label="收件人（仅支持 QQ 邮箱）">
          <el-select
            v-model="emailForm.recipientEmails"
            multiple
            filterable
            allow-create
            default-first-option
            placeholder="请输入或选择 QQ 邮箱"
            style="width: 100%"
          >
            <el-option
              v-for="item in presetRecipients"
              :key="item.email"
