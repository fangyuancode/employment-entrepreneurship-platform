          ...
          <el-row :gutter="16">
            ...
            <el-col :span="24">
              <el-form-item label="目标用户" prop="targetUsers">
                <el-input
                  ...
                  type="textarea"
                  :rows="3"
                  placeholder="如：高校创业团队、文创品牌主理人、独立开发者"
                />
              </el-form-item>
            </el-col>
            ...
            <el-col :span="24">
              <el-form-item label="核心产品/服务" prop="coreProduct">
                <el-input
                  v-model="form.coreProduct"
                  type="textarea"
                  :rows="3"
                  placeholder="请输入你的核心产品或服务内容"
                />
              </el-form-item>
            </el-col>
            ...
            <el-col :span="24">
              <el-form-item label="核心优势" prop="coreAdvantage">
                <el-input
                  v-model="form.coreAdvantage"
                  type="textarea"
                  :rows="3"
                  placeholder="如：AI生成效率高、内容包装完整、适合比赛与项目展示"
                />
              </el-form-item>
            </el-col>
            ...
            <el-col :span="24">
              <el-form-item label="使用场景" prop="usageScenario">
                <el-input
                  ...
                  type="textarea"
                  :rows="3"
                  placeholder="如：比赛路演、官网展示、公众号宣传、海报推广、短视频传播"
                />
              </el-form-item>
            </el-col>
      ...
      >
        ...
        <template v-if="result.projectName">
          ...
          <div class="result-vertical">
            ...
            <div class="result-section highlight">
              ...
              <div v-if="result.sceneImageMap?.heroScene" class="inline-image-block">
                ...
                <div class="single-image-card">
                  <img
                    :src="getPreviewImage(result.sceneImageMap.heroScene)"
                    alt="官网首屏场景图"
            ...
            <div class="result-section">
              ...
              <div v-if="result.sceneImageMap?.posterScene" class="inline-image-block">
                ...
                <div class="single-image-card">
                  <img
                    :src="getPreviewImage(result.sceneImageMap.posterScene)"
                    alt="海报文案宣传图"
                    crossorigin="anonymous"
                  />
                </div>
            ...
            <div class="result-section">
              ...
              <div v-if="result.sceneImageMap?.socialScene" class="inline-image-block">
                ...
                <div class="single-image-card">
                  <img
                    :src="getPreviewImage(result.sceneImageMap.socialScene)"
                    alt="社媒传播配图"
                    crossorigin="anonymous"
                  />
                </div>
            ...
            <div class="result-section">
              ...
              <div v-if="result.sceneImageMap?.sellingPoints" class="inline-image-block">
                ...
                <div class="single-image-card">
                  <img
                    :src="getPreviewImage(result.sceneImageMap.sellingPoints)"
                    alt="产品卖点理解图"
                    crossorigin="anonymous"
                  />
                </div>
            ...
            <div class="result-section" v-if="result.sceneImageMap?.brandVisual">
              ...
              <div class="single-image-card">
                <img
                  :src="getPreviewImage(result.sceneImageMap.brandVisual)"
                  alt="品牌主视觉图"
                  crossorigin="anonymous"
                />
              </div>
          ...
          <div class="result-actions">
            <el-button :loading="generatingImages" @click="handleGenerateImages"
              >重新生成配图</el-button
            >
