    ...
    <div class="top-panel">
      <el-card shadow="never" class="filter-card">
        <div class="filter-header">
          <div>
            <h2 class="page-title">岗位数据分析大屏</h2>
            ...
            <div v-loading="aiLoading" class="ai-result">
              <template v-if="aiResult.summary">
                ...
                <div class="result-block">
                  ...
                  <div class="tag-wrap">
                    <el-tag
                      v-for="(item, index) in aiResult.recommendedSkills"
                      :key="'skill-' + index"
                      class="tag-item"
                    >
                      {{ item }}
                ...
                <div class="result-block">
                  ...
                  <div class="tag-wrap">
                    <el-tag
                      v-for="(item, index) in aiResult.recommendedCompanies"
                      :key="'company-' + index"
                      type="success"
                      effect="plain"
                      class="tag-item"
                ...
                <div class="result-block">
                  ...
                  <div class="tag-wrap">
                    <el-tag
                      v-for="(item, index) in aiResult.recommendedCities"
                      :key="'city-' + index"
                      type="warning"
                      effect="plain"
                      class="tag-item"
                ...
                <div class="result-block">
                  ...
                  <div class="tag-wrap">
                    <el-tag
                      v-for="(item, index) in aiResult.deliveryKeywords"
                      :key="'keyword-' + index"
                      type="info"
                      effect="plain"
                      class="tag-item"
                ...
                <div class="result-block">
                  ...
                  <el-timeline>
                    <el-timeline-item
                      v-for="(item, index) in aiResult.learningPath"
                      :key="'path-' + index"
                    >
                      {{ item }}
                    </el-timeline-item>
...
<script setup lang="ts">
  ...
  const renderCharts = () => {
    ...
    cityChart?.setOption({
      ...
      yAxis: { type: 'value' },
      series: [
        { type: 'bar', data: dashboard.cityDistribution.map((i) => i.value), barMaxWidth: 42 }
      ]
    })
  }
